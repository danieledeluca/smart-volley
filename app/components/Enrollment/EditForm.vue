...
watchEffect(() => {
    if (enrollment.value) {
        state.value = {
            ...
            volleyBalanceDate: enrollment.value.volleyBalanceDate ?? undefined,
            volleyBalanceType: enrollment.value.volleyBalanceType ?? undefined,
            volleySecondBalance: enrollment.value.volleySecondBalance ?? undefined,
            volleySecondBalanceDate: enrollment.value.volleySecondBalanceDate ?? undefined,
            volleySecondBalanceType: enrollment.value.volleySecondBalanceType ?? undefined,
